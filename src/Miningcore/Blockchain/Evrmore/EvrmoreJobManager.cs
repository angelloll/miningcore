...
public class EvrmoreJobManager : BitcoinJobManagerBase<EvrmoreJob>
{
    public EvrmoreJobManager(
    ...
    private static EvrmoreJob CreateJob()
    {
        ...
        if(poolConfig.EnableInternalStratum == true)
        {
            ...
            do
            {
                ...
                if(blockTemplate?.Response != null)
                {
                    ...
                    await coin.EvrprogpowHasher.GetCacheAsync(logger, (int) blockTemplate.Response.Height);
    ...
    protected override async Task<(bool IsNew, bool Force)> UpdateJob(CancellationToken ct, bool forceUpdate, string via = null, string json = null)
    {
        try
        {
            ...
            if(isNew || forceUpdate)
            {
                ...
                var evrprogpowHasher = await coin.EvrprogpowHasher.GetCacheAsync(logger, (int) blockHeight);

                job.Init(blockTemplate, NextJobId(),
                    poolConfig, extraPoolConfig, clusterConfig, clock, poolAddressDestination, network, isPoS,
                    ShareMultiplier, coin.CoinbaseHasherValue, coin.HeaderHasherValue, evrprogpowHasher);
